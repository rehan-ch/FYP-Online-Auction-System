        ...
        <div className="container d-flex justify-content-between">
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav">
              <Link className="nav-item nav-link active text-light" to="/admin/items">Items</Link>
              <Link className="nav-item nav-link active text-light" to="/admin/users">Users</Link>
              {
                isMobile ?(
                  <>
                  {
